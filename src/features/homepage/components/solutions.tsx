...
import { BoltIcon, BoltBoardIcon } from "@/components/icons/custom-icons";
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 py-32 px-5 md:px-0">
        ...
        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2">
          <SectionTitle className="text-4xl">
            Transforming Legal Workflows with Tailored{" "}
            <span className="text-green-500">
              Digital Solutions for Professionals <br />{" "}
            </span>
          </SectionTitle>
        </div>
        ...
        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2">
          <p className="font-light text-sm md:text-base">
            Our innovative digital solutions streamline legal processes,
            enhancing efficiency and accessibility. Empower your practice with
            technology designed specifically for legal professionals.
          </p>
        </div>
          ...
          {headlines.map((headline, index) => (
            <Fragment key={headline.id}>
              ...
              {index + 1 < headlines.length && (
                <Separator className="h-48" orientation="vertical" />
              )}
            </Fragment>
          ))}
        </div>
        ...
        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-7 md:row-span-4 row-start-5 md:row-start-1 bg-gray-200 h-full rounded-xl overflow-hidden">
          <Image
            src={"/images/devon-solutions.png"}
...
const headlines = [
  {
    ...
    description:
      "Reduce administrative burdens and focus more on delivery justice to your clients",
  ...
  },
  {
    ...
    description:
      "Bridge the gap between legal services and the public with our innovative tools.",
...
const SolutionsHeadline = ({
  headline,
}: {
  headline: { icon: React.ReactNode; text: string; description: string };
}) => {
  return (
