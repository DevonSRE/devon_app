            ...
            <div key={member.id} className="flex flex-col gap-4">
              <div className="h-80 w-80 bg-neutral-200 grid place-content-center rounded-xl overflow-hidden">
                {member.imageUrl ? (
                  ...
                  <Image
                    src={"/svg/devon-white-plain-logo.svg"}
                    alt={member.name}
                    height={200}
                    width={200}
...
const teamMembers = [
  {
    ...
    role: "Board Chairman",
    imageUrl:
      "https://drive.google.com/file/d/1xAB9xHl2Qxvskfp0cG5gseWdmy8cIWDU/view",
  },
  {
    id: 2,
    ...
    role: "C.E.O PPDC",
    imageUrl:
      "https://drive.google.com/file/d/18344picrRgohwcIAkaBiXHdDNJLlU2zC/view",
  },
  {
    id: 3,
    ...
    role: "Board Member",
    imageUrl:
      "https://drive.google.com/file/d/13h37LURrq-JsEv_Tb_6_P1xgpNBad6Bh/view",
  },
];
