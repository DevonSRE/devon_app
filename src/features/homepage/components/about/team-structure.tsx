...
const TeamStructure = () => {
  ...
  const subContentContainerVariants: Variants = {
    initial: {
      translateX: "0px",
  ...
  const subContentToggleVariants: Variants = {
    initial: {
      translateX: "0px",
      borderRadius: "0px",
      transition: { duration: 0.2, type: "spring", stiffness: 50 },
  ...
  const subContentItemsVariants: Variants = {
    initial: {
  ...
  const subContentListItemsVariants: Variants = {
    ...
    <div className="bg-neutral-950 text-white">
      <div className="max-w-screen-sm md:max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 md:gap-x-10 py-20 md:py-24 px-5 md:px-0">
        ...
        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2 flex flex-col gap-5 md:gap-10 mt-5 md:mt-0">
          {structures.map((structure) => (
            <div
              key={structure.id}
              className={cn(
                "flex items-center justify-start md:justify-between gap-2 md:gap-4 hover:cursor-pointer",
                {
            ...
            >
              ...
              <SectionTitle className="text-xl md:text-3xl">
                {structure.name}
              </SectionTitle>
              <div>----------&gt;</div>
            </div>
        ...
        <div className="col-start-1 md:col-start-7 col-end-2 md:col-end-12 md:row-start-2 md:row-span-2 flex flex-col gap-5 md:gap-10">
          <SectionTitle className="text-2xl md:text-4xl ml-20 hidden md:block">
            Focus
          </SectionTitle>
          ...
          <div className="relative rounded-xl bg-white text-neutral-950 min-h-[380px] md:min-h-[520px]">
            ...
            <div className="relative overflow-hidden size-full space-y-2.5 md:space-y-5 p-8 md:p-16">
              ...
              <p className="font-light text-sm md:text-base text-neutral-500">
              ...
              >
                ...
                >
                  <Image
                    src={"/svg/devon-subcontent-toggle.svg"}
                    alt="toggle-icon"
                    height={24}
                    width={24}
