...
const ContactUs = () => {
  return (
    <div
      className={
        "max-w-screen-sm md:max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-y-8 gap-x-16 py-32 px-5 md:px-0"
      }
    >
      ...
      <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2 font-light">
        <p>
          We invite you to share your challenges and together, we can explore
          tailored solutions that align with your goals and drive meaningful
          change.
        </p>
      </div>
