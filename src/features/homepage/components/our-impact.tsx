      ...
      <div className="max-w-screen-sm md:max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 pt-48 pb-32 md:py-52 px-5 md:px-0">
        ...
        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2">
          <SectionTitle className="text-2xl md:text-4xl">
            <span className="text-devon-purple">Our Impact </span> Through{" "}
            <br /> Innovative Software Solutions
          </SectionTitle>
        </div>

        <div className="col-span-full md:col-span-5 col-start-1 md:col-start-2">
          <p className="font-light text-neutral-400">
            At Devon Technology, we are proud to have empowered over 20
            organizations across Nigeria. Our innovative software solutions have
            successfully addressed critical social issues, fostering
...
const StatsDisplay = ({
  ...
  stat: { text: string; description: string };
}) => {
  return (
