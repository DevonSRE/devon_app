      ...
      <div className="max-w-screen-sm md:max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 py-40 px-5 md:px-0">
        ...
        <div className="col-span-full md:col-span-4 col-start-1 md:col-start-2">
          <p className="font-light text-sm md:text-base">
            ...
            meticulously crafted to streamline complex legal processes, improve
            operational efficiency, and enhance access to justice. Our
            innovative tools are designed to empower legal professionals,
            optimize case management, and bridge the gap between technology and
            the legal system—ensuring faster, smarter, and more transparent
            legal outcomes.
          </p>
        </div>
