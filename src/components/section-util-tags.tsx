...
const colorVariants = {
  ...
  "green-dark": {
    ...
    outline:
      "p-px rounded-md bg-gradient-to-b from-green-950 via-green-700 to-green-950",
  },
  purple: {
  ...
  "purple-dark": {
    ...
    outline:
      "p-px rounded-md bg-gradient-to-b from-devon-purple via-devon-purple/70 to-devon-purple",
  },
  red: {
  ...
  "red-dark": {
    ...
    outline:
      "p-px rounded-md bg-gradient-to-b from-rose-950 via-rose-700 to-rose-950",
  },
  gray: {
  ...
  "gray-dark": {
    ...
    outline:
      "p-px rounded-md bg-gradient-to-b from-neutral-950 via-neutral-700 to-neutral-950",
  },
};

export type TColorVariants = keyof typeof colorVariants;
...
const SectionTag = ({
  ...
  return (
    <div
      className={cn(
        color ? colorVariants[color].outline : colorVariants["gray"].outline,
      )}
    >
      <div
        className={cn(
